...
class SliverFloatingBarNoPadding extends StatefulWidget {
  /// Creates a material design app bar that can be placed in a [CustomScrollView].
  ///
  /// The arguments [forceElevated], [primary], [floating], [pinned], [snap]
  /// and [automaticallyImplyLeading] must not be null.
  const SliverFloatingBarNoPadding({
    Key key,
    this.leading,
  ...
  @override
  _SliverFloatingBarNoPaddingState createState() => _SliverFloatingBarNoPaddingState();
}

class _SliverFloatingBarNoPaddingState extends State<SliverFloatingBarNoPadding>
